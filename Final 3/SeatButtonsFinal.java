...
public class SeatButtonsFinal extends JPanel 
	{
			//Set up image icon objects for the radio buttons.
	...
	//		JLabel blank2 = new JLabel ("");
			...
			JLabel blank3 = new JLabel ("Price");
		...
		//	JLabel b1 = new JLabel(" | "), b2 = new JLabel(" | "), b3 = new JLabel(" | "), b4 = new JLabel(" | "), b5 = new JLabel(" | "), b6 = new JLabel(" | "), b7 = new JLabel(" | "), b8 = new JLabel(" | "), b9 = new JLabel(" | "), b10 = new JLabel(" | "), b11 = new JLabel(" | "), b12 = new JLabel(" | "), b13 = new JLabel(" | ");
			...
			//data separator labels
			JLabel m1 = new JLabel(" ($507.00) "), m2 = new JLabel(" "), m3 = new JLabel(" ($420.00) "), m4 = new JLabel("  "), m5 = new JLabel("  "), m6 = new JLabel("  "), m7 = new JLabel(" "), m8 = new JLabel(" ($250.00) "), m9 = new JLabel(" "), m10 = new JLabel("  "), m11 = new JLabel("  "), m12 = new JLabel("  "), m13 = new JLabel("  ");
			//price labels
			JLabel p1 = new JLabel(""), p2 = new JLabel(""), p3 = new JLabel(""), p4 = new JLabel(""), p5 = new JLabel(""), p6 = new JLabel(""),p7 = new JLabel(""), p8 = new JLabel(""), p9 = new JLabel(""), p10 = new JLabel(""), p11 = new JLabel(""), p12 = new JLabel(""), p13 = new JLabel("");
			//data separator labels
		...
		private class SeatSelected implements ActionListener
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if (myButton.getIcon() == ii1)
					{
					
					myButton.setIcon(ii2);
			...
			public void actionPerformed(ActionEvent e)
			{
				if (this==co)
					...
					if(list.size() > 0)
					{
						...
						dialogButton = JOptionPane.showConfirmDialog ( null, "Did you select all the seats you want?","Warning", dialogButton );
					...
					{
						JOptionPane.showMessageDialog(null, "**No seats were selected**", "ERROR", JOptionPane.ERROR_MESSAGE);
					}
				}
					//send to info screen
				else if (this==rst)
				{
					...
					{
//*****************2.0 CHANGE**************************\\
			//asks confirm exit screen
					int dialogButton = JOptionPane.YES_NO_OPTION;
						dialogButton = JOptionPane.showConfirmDialog(null, "Are you sure you would like to exit?", "Warning", dialogButton );
						  if (dialogButton == JOptionPane.YES_OPTION)
						  {
//*******************************************************\\						  
						sfile.delete();
		...
		public static void createAndShowGUI()
			...
			sfile = new File (System.getProperty("user.dir") + "/Reservations/" + resID + ".txt");
...
//*****************************2.0 CHANGE********************************************\\
	 // Centers window.... kinda
			Dimension ss = Toolkit.getDefaultToolkit ().getScreenSize ();
			Dimension frameSize = new Dimension ( 500, 300 );

			
			frame.setBounds ( ss.width / 2 - frameSize.width / 2 - 300, 
			                  ss.height / 2 - frameSize.height / 2 - 250,
...
//***********************************************************************************\\				
		...
		public void reset()
			{
//*************************************2.0 Change***********************************************************************\\
	// asks for confirm reset seats
			int dialogButton = JOptionPane.YES_NO_OPTION;
			dialogButton = JOptionPane.showConfirmDialog(null, "Are you sure that you would like to reset your seats?", "Warning", dialogButton);
			  if ( dialogButton == JOptionPane.YES_OPTION)
			  {
//**********************************************************************************************************************\\
		...
		public static void main (String[] args)
			{
				//Set the image icons to be the included image files.
		        try 
		        {
		            ii1 = new ImageIcon(("available.png"));
		            ii2 = new ImageIcon(("booking.png"));
		        }
		        catch (Exception ex)
		        {
		            ex.printStackTrace();
